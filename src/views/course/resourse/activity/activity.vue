<template>
  <div class="activity">
          ...
          <div style="display: flex;margin: 25px 0;">
            <div style="display: flex">
              <div style="width: 300px">
                <el-input placeholder="查找活动" v-model="input"></el-input>
              </div>
              <div>
    ...
    <!-- 查看活动弹窗-->
    <el-dialog title="提示" :visible.sync="showCatalog" width="30%">
      <span>这是一段信息</span>
      <span slot="footer" class="dialog-footer">
        ...
        data.forEach(item => {
          ...
          if (item.interactionList.length !== 0) {
            ...
            item.interactionList.forEach(list => {
              list.interactionTitle = list.interactionTitle.replace(
                /<[^>]+>/g,
                ""
              ); //去掉所有的html标记
              item.childList.push({
