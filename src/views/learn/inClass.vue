<template>
  <div>
    <div style="margin-bottom: 20px">
      <el-select filterable v-model="course" placeholder="请选择">
        <el-option
    ...
    <el-tabs v-model="activeName" type="border-card" @tab-click="handleClick">
      <el-tab-pane label="课堂行为" name="first">
        <!--为echarts准备一个具备大小的容器dom-->
        <div id="chart1" style="height: 400px;" v-show="isChart1"></div>
        <div style="height: 400px;" v-show="isChart1Data">
          <div
            style="font-size:18px;font-weight: bold;display:inline-block; margin-bottom: 20px"
          >┃课堂行为参与率</div>
        ...
        <el-table :data="tableData" border style="width: 100%">
          <el-table-column label="授课时间" width="120">
          ...
          <el-table-column label="授课时长" width="120">
            <template slot-scope="scope">
      ...
      <el-tab-pane label="学情质量" name="second">
        <!--为echarts准备一个具备大小的容器dom-->
        <div id="chart2" style="width: 1000px;height: 400px;" v-show="isChart2"></div>
