...
const tenantProd = 'http://apidev.teamsking.com:9008/api/v1/login/tenant' // 生产环境
const tenantUrl = process.env.NODE_ENV === 'production' ? tenantProd : tenantDev

const tokenDev = '/api/v1/token/accessToken' // 开发环境
const tokenProd = 'http://apidev.teamsking.com:9008/api/v1/api/v1/token/accessToken' // 生产环境
