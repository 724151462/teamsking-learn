...
export function getTestFileFold(data) {
  let url = `/library/quiz/quizzes`
  return commonsAjax(url, data, 'post')
}

export function getAnswer(data) {
  let url = `/library/quiz/${data.quizId}/options`
  return commonsAjax(url, '', 'get')
}
//上传试题模板
export function upQuiz(data) {
  let url = `/library/quiz/import`
  return commonsAjax(url, data, 'post')
}

//保存新试题
export function saveQuiz(data) {
  let url = `/library/quiz`
  console.log(data)
  return commonsAjax(url, data, 'post')
}
...
export function getResList(data) {
  let url = `/library/resource/resources`
  return commonsAjax(url, data, 'post')
}
/**
 * 课堂模式下获取资源列表
...
export function classRes(data) {
  let url = `/library/resource/resources/async`
  return commonsAjax(url, data, 'post')
}
/**
 * 新建资源文件夹
...
export function newResFileFold(data) {
  let url = `/library/resource/catalog`
  return commonsAjax(url, data, 'post')
}
/**
 * 资源id获取资源信息
...
export function getFileDetail(data) {
  let url = `/library/resource/${data.resourceId}`
  return commonsAjax(url, '', 'get')
}
/**
 * 移动资源
...
export function deleteAc(data) {
  let url = `/library/interaction/catalog`
  return commonsAjax(url, data, 'delete')
}
/**
 * 活动移动到另外的文件夹
...
export function removeAc(data) {
  console.log(data)
    let url = `/library/catalog/interaction`
    return commonsAjax(url, data, 'patch')
}
/**
 * 创建活动文件夹
...
export function getAcList(data) {
    let url = `/library/interaction/interactions`
    return commonsAjax(url, data, 'post')
}
/**
 * 获取头脑风暴的信息
...
export function getStormInfo(data) {
  let url = `/course/storm/record/${data}`
  return commonsAjax(url, '', 'get')
}
/**
 * 获取作业的信息
